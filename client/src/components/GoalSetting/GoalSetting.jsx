...
export default function GoalSetting() {
  return (
    <>
      ...
      <section className=" py-5 py-xl-8"  style={{ overflow: "auto", height: "87vh" }}>
        <div className="container">
          <Header title = "Missions & Objectives" subtitle = "" />
        ...
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-xl-0">
            ...
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5 card-equal-height d-flex flex-column min-vh-50">
            ...
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5 card-equal-height d-flex flex-column min-vh-50  ">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-heart-pulse text-primary mb-4 whySetGoalsIcons" viewBox="0 0 16 16">
                     ...
                     <p className="mb-4 text-secondary">Clearly defined goals and plans can reduce stress. Alleviating the uncertainty and anxiety associated with the unknown, and paving way for the future.</p>
