...
//                   <div className="card-body text-center p-4 p-xxl-5 card-equal-height ">
...
//                     <p className="mb-4 text-secondary">Writing down your goals provides clarity, helping you
//                     visualize and understand your aspirations clearly.</p>
...
//                     <p className="mb-4 text-secondary">you are better able to focus on what needs to be done to achieve them, a constant reminder of your priorities.</p>
//                     <a href="https://lucemiconsulting.co.uk/writing-down-your-goals/" target='_blank' className="fw-bold text-decoration-none link-primary">
//                       Learn More
//                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-short whySetGoalsIcons" viewBox="0 0 16 16">
//                         <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
